...
public class FilmController {
    ...
    public List<Film> getFilmsByDirectorSortedByParam(@PathVariable Long directorId, @RequestParam(defaultValue = "likes") String by) {
        return serviceFilms.getFilmsToDirector(directorId, by);
    }
