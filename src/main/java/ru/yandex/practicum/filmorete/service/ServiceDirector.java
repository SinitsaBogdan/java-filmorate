...
import static ru.yandex.practicum.filmorete.exeptions.message.DirectorErrorMessage.SERVICE_ERROR_DIRECTOR_DUPLICATE_IN_COLLECTIONS;
...
public class ServiceDirector {
    ...
    public Director getDirectorSearchId(Long directorId) {
        ...
        if (result.isPresent()) throw new ExceptionNotFoundDirectorStorage(SERVICE_ERROR_DIRECTOR_NOT_IN_COLLECTIONS);
        return result.get();
    }
    ...
    public Director add(@NotNull Director director) {
        ...
        if (optionalDirector.isPresent()) throw new ExceptionNotFoundDirectorStorage(SERVICE_ERROR_DIRECTOR_DUPLICATE_IN_COLLECTIONS);
    ...
    public Director update(@NotNull Director director) {
        ...
        if (optionalDirector.isEmpty()) throw new ExceptionNotFoundDirectorStorage(SERVICE_ERROR_DIRECTOR_NOT_IN_COLLECTIONS);
    ...
    public void deleteSearchId(Long directorId) {
        ...
        if (optional.isEmpty()) throw new ExceptionNotFoundDirectorStorage(SERVICE_ERROR_DIRECTOR_NOT_IN_COLLECTIONS);
