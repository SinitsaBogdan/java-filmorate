...
import ru.yandex.practicum.filmorate.exeptions.ExceptionNotFoundFilmStorage;
import ru.yandex.practicum.filmorate.exeptions.ExceptionNotFoundUserStorage;
import ru.yandex.practicum.filmorate.model.Film;
import ru.yandex.practicum.filmorate.model.Genre;
import ru.yandex.practicum.filmorate.model.TotalGenreFilm;
import ru.yandex.practicum.filmorate.model.User;
import ru.yandex.practicum.filmorate.sql.dao.FilmDao;
import ru.yandex.practicum.filmorate.sql.dao.TotalFilmLikeDao;
import ru.yandex.practicum.filmorate.sql.dao.TotalGenreFilmDao;
import ru.yandex.practicum.filmorate.sql.dao.UserDao;

import java.util.*;

import static ru.yandex.practicum.filmorate.exeptions.MessageErrorValidFilm.VALID_ERROR_FILM_DOUBLE_IN_COLLECTIONS;
import static ru.yandex.practicum.filmorate.exeptions.MessageErrorValidFilm.VALID_ERROR_FILM_ID_NOT_IN_COLLECTIONS;
import static ru.yandex.practicum.filmorate.exeptions.MessageErrorValidUser.VALID_ERROR_USER_ID_NOT_IN_COLLECTIONS;
import static ru.yandex.practicum.filmorate.service.ServiceValidators.checkValidFilm;
