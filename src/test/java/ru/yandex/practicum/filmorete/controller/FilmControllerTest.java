...
public class FilmControllerTest {
    ...
    @Autowired
    private TotalDirectorFilmDao totalDirectorFilmDao;
    ...
    public class MethodPost {
        ...
        public void methodPost_NewFilmValidFalse_DescriptionMaxLengthTest() throws Exception {
            Film film = Film.builder()
                ...
                .name("Фильм 10")
                .description(
                    "Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название. Очень длинное название.")
                .genres(Collections.singletonList(Genre.builder().id(1).build()))
                .releaseDate(LocalDate.parse("2000-01-01"))
                .duration(90)
                .rate(5)
    ...
    public class MethodPut {
        ...
        public void methodPut_FilmValidFalse_WhitespaceTest() throws Exception {
            Film film = Film.builder()
                ...
                .name("update")
                .description(
                    "Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание. Очень длинное описание.")
                .genres(Collections.singletonList(Genre.builder().id(1).build()))
                .releaseDate(LocalDate.parse("2010-01-01"))
                .duration(120)
                .rate(7)
